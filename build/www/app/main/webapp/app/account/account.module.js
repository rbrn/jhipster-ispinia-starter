...
var _1 = require("./");
var StipAccountModule = (function () {
    function StipAccountModule() {
    }
    StipAccountModule = __decorate([
        core_1.NgModule({
            imports: [
    ...
    return StipAccountModule;
}());
exports.StipAccountModule = StipAccountModule;
