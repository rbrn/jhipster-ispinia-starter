...
var StipSharedLibsModule = (function () {
    function StipSharedLibsModule() {
    }
    StipSharedLibsModule = __decorate([
        core_1.NgModule({
            imports: [
    ...
    ], StipSharedLibsModule);
    return StipSharedLibsModule;
}());
exports.StipSharedLibsModule = StipSharedLibsModule;
