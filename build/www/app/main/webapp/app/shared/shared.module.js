...
var _1 = require("./");
var StipSharedModule = (function () {
    function StipSharedModule() {
    }
    StipSharedModule = __decorate([
        core_1.NgModule({
            imports: [
                _1.StipSharedLibsModule,
                _1.StipSharedCommonModule
            ],
            declarations: [
    ...
    return StipSharedModule;
}());
exports.StipSharedModule = StipSharedModule;
